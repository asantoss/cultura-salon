...
export default function privacyPolicy() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Cultura Salon LLC, 2570
            Blackmon Dr. ,Suite 440, Decatur, GA 30033.
          </p>
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Cultura Salon, accessible from
          www.culturasalon.com
        </li>{" "}
        <li>
      ...
      <ul>
        <li>By email: addysantos.hm@gmail.com</li>
      </ul>
    </>
  )
}
